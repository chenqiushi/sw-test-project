...
function fetchAndCache(req, options) {
    return fetch(req.clone()).then(function (response) {
        if (req.method === 'GET' && isSuccResponse(response.status)) {
            saveCache(req, response, options);
        }
...
function isResponseFresh(res, maxAgeSeconds, now) {
    if (!res) {
        return false;
    }
...
function saveCache(req, res, options) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__strategies__ = __webpack_require__(56);
...
function getStrategy(name) {
    if (!name || __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_keys___default()(__WEBPACK_IMPORTED_MODULE_1__strategies__["a" /* default */]).indexOf(name) === -1) {
        return;
    }

    return __WEBPACK_IMPORTED_MODULE_1__strategies__["a" /* default */][name];
}

function matchInner(methodArr, url) {
    var matchItem = void 0;

    for (var i = 0; i < methodArr.length; i++) {
        var urlPattern = methodArr[i].urlPattern;

        if (urlPattern.test(url)) {
            matchItem = methodArr[i];
            break;
        }
    }
...
/* harmony default export */ __webpack_exports__["a"] = ({
    add: function add(method, urlPattern, strategy, options) {
        ...
        routersMap[method].push({ urlPattern: urlPattern, strategy: strategy, options: options });
    },
    match: function match(request) {
        ...
        if (validMethod.indexOf(method) !== -1) {
            matchItem = matchInner(routersMap[method], request.url);
        }

        if (!matchItem) {
            matchItem = matchInner(routersMap.all, request.url);
        }
...
/* harmony default export */ __webpack_exports__["a"] = (function (req, options) {
    var cacheName = void 0;
    var maxAgeSeconds = void 0;
    if (options && options.cache) {
        cacheName = options.cache.cacheName;
        maxAgeSeconds = options.cache.maxAgeSeconds;
    }
    ...
    return caches.open(cacheName).then(function (cache) {
        return cache.match(req).then(function (res) {
            ...
            if (res && __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__utils__["a" /* isResponseFresh */])(res, maxAgeSeconds, now)) {
                return res;
            }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_sw_base__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__product_news_conf__ = __webpack_require__(60);
...
__WEBPACK_IMPORTED_MODULE_0__lib_sw_base__["a" /* default */].setDefaultOptions({ cache: { name: '@sfe-sw-news@' } });
__WEBPACK_IMPORTED_MODULE_1__product_news_conf__["a" /* default */].routers.forEach(function (router) {
  __WEBPACK_IMPORTED_MODULE_0__lib_sw_base__["a" /* default */].add(router.method, router.urlPattern, router.strategy, router.options);
});
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = fetchListener;
...
function fetchListener(event) {
    var matchItem = __WEBPACK_IMPORTED_MODULE_0__router__["a" /* default */].match(event.request);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cacheOnly__ = __webpack_require__(33);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__cacheFirst__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cacheOnly__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__fastest__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__networkFirst__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__networkOnly__ = __webpack_require__(58);
            ...
            cachePromise = new __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a(function (resolve) {
                timeoutId = setTimeout(function () {
                    cache.match(req).then(function (res) {
                        if (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils__["a" /* isResponseFresh */])(res, maxAgeSeconds, Date.now())) {
                            resolve(res);
                        }
                    });
                }, timeout * 1000);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__router__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__listeners__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__defaults__ = __webpack_require__(52);
...
self.addEventListener('fetch', __WEBPACK_IMPORTED_MODULE_1__listeners__["a" /* fetchListener */]);

/* harmony default export */ __webpack_exports__["a"] = ({
    add: function add(method, urlPattern, strategy, options) {
        if (method === 'get') {
            __WEBPACK_IMPORTED_MODULE_0__router__["a" /* default */].add('get', urlPattern, __WEBPACK_IMPORTED_MODULE_2__defaults__["a" /* default */].getStrategy(strategy), __WEBPACK_IMPORTED_MODULE_2__defaults__["a" /* default */].getOptions(options));
        } else if (method === 'post') {
            __WEBPACK_IMPORTED_MODULE_0__router__["a" /* default */].add('post', urlPattern, __WEBPACK_IMPORTED_MODULE_2__defaults__["a" /* default */].getStrategy(strategy), __WEBPACK_IMPORTED_MODULE_2__defaults__["a" /* default */].getOptions(options));
        } else if (method === 'put') {
            __WEBPACK_IMPORTED_MODULE_0__router__["a" /* default */].add('put', urlPattern, __WEBPACK_IMPORTED_MODULE_2__defaults__["a" /* default */].getStrategy(strategy), __WEBPACK_IMPORTED_MODULE_2__defaults__["a" /* default */].getOptions(options));
        } else if (method === 'delete') {
            __WEBPACK_IMPORTED_MODULE_0__router__["a" /* default */].add('delete', urlPattern, __WEBPACK_IMPORTED_MODULE_2__defaults__["a" /* default */].getStrategy(strategy), __WEBPACK_IMPORTED_MODULE_2__defaults__["a" /* default */].getOptions(options));
        } else if (method === 'all') {
            __WEBPACK_IMPORTED_MODULE_0__router__["a" /* default */].add('all', urlPattern, __WEBPACK_IMPORTED_MODULE_2__defaults__["a" /* default */].getStrategy(strategy), __WEBPACK_IMPORTED_MODULE_2__defaults__["a" /* default */].getOptions(options));
        }
    },
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    routers: [{
        method: 'get',
        urlPattern: /news\/static\/cache.*\.js$/i,
        strategy: 'cacheFirst'
    }, {
        method: 'get',

        urlPattern: /news\/static\/fast.+\.js$/i,
        strategy: 'fastest'
    }, {
        method: 'get',
        urlPattern: /news\/static\/main\.css$/i,
    ...
    test: {
        validUrl: ['/news/static/index.js', '/news/static/main.css']
    }
});
